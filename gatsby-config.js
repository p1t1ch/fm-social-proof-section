const config = {
  ...
  shortTitle: 'FM Social proof section',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Social proof section" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-social-proof-section.netlify.app',
